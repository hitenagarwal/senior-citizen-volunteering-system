 ...
 * @author poonam
 */
public class sc_req extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sc_req.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
